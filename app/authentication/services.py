...
- AuthService: User authentication, profile management, email verification, password reset
- BiometricService: Face ID / Touch ID authentication via ECDSA signatures
...
Security:
    ...
    - Biometric: ECDSA P-256 signature verification, Redis-backed challenges
"""
